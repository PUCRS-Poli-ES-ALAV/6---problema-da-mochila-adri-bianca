...
for capacity, items in test_cases:
    ...
    data.append([capacity, "Brute Force", best_value_brute, iterations_brute])
    data.append([capacity, "Divide & Conquer", best_value_dc, iterations_dc])
    data.append([capacity, "Dynamic Programming", best_value_dp, iterations_dp])

# Exibir os resultados em formato de tabela
headers = ["Capacidade", "Método", "Melhor Valor", "Iterações"]
